...
describe('component with structural directive', () => {
  ...
  it('renders both headings', async () => {
    const { find } = await shallow.withStructuralDirective(MyStructuralDirective).render();
  ...
  it('renders the second heading', async () => {
    ...
    const found = findStructuralDirective(MyStructuralDirective, { query: d => d.myStructuralDirective === 'first' });
  ...
  it('unrenders the heading', async () => {
    const { find, renderStructuralDirective } = await shallow.withStructuralDirective(MyStructuralDirective).render();
